...
__DEFINE__(1662880264537, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1662880264538,"./event-store":1662880264539}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1662880264538, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1662880264539, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1662880264538,"./utils":1662880264540}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1662880264540, function(require, module, exports) {
...
return __REQUIRE__(1662880264537);
})()
